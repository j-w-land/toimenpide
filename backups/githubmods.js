...
function setUpButtonListen() {
    ...
    helpButton.addEventListener('click', () => {
        ...
        if (iconStatus === -1) {
            ...
            //info-ikkunan html:
            let helpPopInfo = ['<div id="helpPopUp" class="card border-info" style="position: absolute; width: 56%; height: 55%; padding: 25px; top: 150px; margin-top: 240px; float: right; right: 22%; border-width: medium; z-index: 2;"><div class="card-header">Hakukoneen käyttäminen</div><div class="card-body"><h4 class="card-title">Toimenpidelista</h4><ul><li class=""> Selaa listaa alas </li><li class=""> Klikkaamalla toimenpidettä aukeaa sen lisätiedot </li></ul><h4 class="card-title">Hakutoiminto</h4><ul><li class=""> Kirjoita hakukenttään hakusana </li> <li class=""> Klikkaamalla toimenpidettä aukeaa sen lisätiedot </li>  </ul>  </div>  </div>'];
